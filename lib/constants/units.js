...
module.exports = Object.freeze({
  ...
  constantMeta: [
    ...
    { value: 0.0254, name: 'M_PER_INCH', description: 'Meters per inch' },
    { value: 0.9144, name: 'M_PER_YARD', description: 'Meters per yard' },
    { value: 1.60934, name: 'KM_PER_MILE', description: 'Kilometers per mile (approx)' },
    { value: 1.609344, name: 'KM_PER_MILE_EXACT', description: 'Kilometers per mile (exact)' }
  ],
  terms: [
